...
//!
//! A software-driven [Generic Driver](crate::drivers::generic::Generic) is available
//! for applications where driving a motor, actuator, stepper, etc., through bit-banging
//! is acceptable.
//!
